...
![适配器模式](/images/design-pattern-adapter.jpg "Adapter")
...
![算法库重用结构图](/images/design-pattern-adapter-example.jpg "Adapter Example")
...
![类适配器模式结构图](/images/design-pattern-adapter-class.jpg "Class Adapter")
...
![双向适配器结构示意图](/images/design-pattern-adapter-dual.jpg "Dual Adapter")
