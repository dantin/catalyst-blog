...
![单例模式负载均衡器结构图](/images/design-pattern-singleton-example.gif "Singleton Load Balance")
...
![饿汉单例模式](/images/design-pattern-singleton-eager.gif "Singleton Eager")
...
![懒汉单例模式](/images/design-pattern-singleton-lazy.gif "Singleton Lazy")
