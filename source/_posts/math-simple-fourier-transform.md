...
![音乐是什么](/images/fourier-01.jpg "What is Music")

这是我们对音乐最普遍的理解，一个随着时间变化的震动。但我相信对于乐器小能手们来说，音乐更直观的理解是这样的：

![乐谱](/images/fourier-02.jpg "That is Music")
...
![正弦波累加](/images/fourier-06.jpg "正弦波累加")
...
![正弦波定义](/images/fourier-07.jpg "正弦波定义")
...
![正弦波在频域](/images/fourier-10.jpg "正弦波在频域")

这是什么奇怪的东西？

这就是矩形波在频域的样子，是不是完全认不出来了？教科书一般就给到这里然后留给了读者无穷的遐想，以及无穷的吐槽，其实教科书只要补一张图就足够了：频域图像，也就是俗称的频谱，就是——

![频域图像一](/images/fourier-11.jpg "频域图像一")

再清楚一点

![频域图像二](/images/fourier-12.jpg "频域图像二")
...
![7个波叠加的图](/images/fourier-14.jpg "7个波叠加的图")

鉴于正弦波是周期的，我们需要设定一个用来标记正弦波位置的东西。在图中就是那些小红点。小红点是距离频率轴最近的波峰，而这个波峰所处的位置离频率轴有多远呢？为了看的更清楚，我们将红色的点投影到下平面，投影点我们用粉色点来表示。当然，这些粉色的点只标注了波峰距离频率轴的距离，并不是相位。

![投影](/images/fourier-15.jpg "投影")
...
![傅里叶变换](/images/fourier-17.jpg "傅里叶变换")
...
![频率方向](/images/fourier-18.jpg "频率方向")
...
![频率方向连续](/images/fourier-19.jpg "频率方向连续")
...
![欧拉公式的涵义](/images/fourier-24.jpg "欧拉公式的涵义")
...
![连续的螺旋线](/images/fourier-28.jpg "连续的螺旋线")

是不是很漂亮？

你猜猜，这个图形在时域是什么样子？

![连续的螺旋线在时域](/images/fourier-29.jpg "连续的螺旋线在时域")
...
![傅里叶变换以及傅里叶级数总结](/images/fourier-30.jpg "傅里叶变换以及傅里叶级数总结")
