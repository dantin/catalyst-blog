...
![图形界面构件库初始设计方案](/images/design-pattern-decorator-problem-structure.gif "Decorator Problem Structure")
...
![图形界面构件库结构图](/images/design-pattern-decorator-example.gif "Decorator Example")
...
![文件对象功能增加实例结构图](/images/design-pattern-decorator-semi-transparent.gif "Decorator Semi Transparent")
...
![没有抽象构件类的装饰模式](/images/design-pattern-decorator-no-component.gif "Decorator No Component")
